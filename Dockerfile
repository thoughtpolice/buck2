...
ENV RUSTUP_HOME=/usr/local/rustup \
    ...
    RUST_VERSION=nightly-2025-03-29
...
RUN set -eux; \
    ...
    wget https://apt.llvm.org/llvm.sh; \
        ...
        rm llvm.sh; \
    update-alternatives \
        --install /usr/bin/clang clang /usr/bin/clang-20 40 \
    ...
    ./rustup-init -y --no-modify-path \
        --profile minimal --default-toolchain $RUST_VERSION --default-host ${rustArch} \
